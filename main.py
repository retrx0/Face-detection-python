...
while True:
    ...
    cascade_face_alt = cv2.CascadeClassifier(
        'data/haarcascades/haarcascade_frontalface_alt.xml')
    cascade_face_alt2 = cv2.CascadeClassifier(
    ...
    for (x, y, w, h) in faces_rects:
        cv2.rectangle(vid_frame, (x, y), (x + w, y + h), (0, 255, 0), 1)
    ...
    for (x, y, w, h) in faces_circle_alt2:
        ...
        cv2.line(vid_frame, (x + int(w / 2) - 30, y + int(h / 2) + 80), (x + int(w / 2) + 30, y + int(h / 2) + 80),
                 (0, 255, 255), 1)
